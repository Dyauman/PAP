...
//Methoden Definition fuer Menueleiste (PAP-Bild als PDF oder Bild speichern)
...
int main(int argc, char *argv[])
{
    ...
    horizontalLayout->addWidget(new symbWidget);
    horizontalLayout->addWidget(new papWidget);
    horizontalLayout->addWidget(new deleteWidget);
    mainWidget->setWindowTitle(QObject::tr("PAP-Design"));
